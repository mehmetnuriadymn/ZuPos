...
type AvatarData = { name: string; color: string };
...
function renderSparklineCell(params: GridCellParams) {
  ...
  const sparklineValue = value as SparkLineData;

  if (!sparklineValue || sparklineValue.length === 0) {
    return null;
  }
...
export function renderAvatar(params: GridCellParams) {
  ...
  const avatarData = params.value as AvatarData;
...
export const columns: GridColDef[] = [
  { field: "pageTitle", headerName: "Page Title", flex: 1.5, minWidth: 200 },
  {
    ...
    flex: 0.5,
    minWidth: 80,
    renderCell: (params) => renderStatus(params.value as StatusType),
  },
  {
    field: "users",
    headerName: "Users",
